...
#ifndef HAP_OPAQUE_TYPES_32_H
#define HAP_OPAQUE_TYPES_32_H
 ...
 * String builder.
 */
typedef HAP_OPAQUE(16) HAPStringBuilderRef;

/**
 * TLV Reader.
 */
typedef HAP_OPAQUE(16) HAPTLVReaderRef;

/**
 * TLV Writer.
 */
typedef HAP_OPAQUE(16) HAPTLVWriterRef;
HAP_NONNULL_SUPPORT(HAPTLVWriterRef)

/**
 * HomeKit Accessory server.
 */
typedef HAP_OPAQUE(1736) HAPAccessoryServerRef;
HAP_NONNULL_SUPPORT(HAPAccessoryServerRef)

/**
 * HomeKit Session.
 */
typedef HAP_OPAQUE(392) HAPSessionRef;
HAP_NONNULL_SUPPORT(HAPSessionRef)

/**
 * IP request context.
 */
typedef HAP_OPAQUE(40) HAPIPCharacteristicContextRef;

/**
 * IP session descriptor.
 */
typedef HAP_OPAQUE(640) HAPIPSessionDescriptorRef;
 ...
 */
typedef HAP_OPAQUE(32) HAPBLEGATTTableElementRef;
 ...
 */
typedef HAP_OPAQUE(104) HAPBLEProcedureRef;
